...
const TABLE = {
  ...
  "leadership--erudition": ["言葉で導く語り手", "言葉を尽くして人を動かすことに関心が向きます。"],
  ...
  "organization--production": ["順序立てて仕上げる実務役", "手順を決めてから手を動かす進め方に惹かれます。"],
  "organization--adventure": ["備えてから飛び込む実行役", "思い切って動く前に、準備を固めておきたいほうです。"],
  "organization--erudition": ["書き留めて整える記録役", "情報を集めて整理し、残す形にすることに惹かれます。"],
